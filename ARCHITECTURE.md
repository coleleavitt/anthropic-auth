...
**rewriteRequestBody:**
- Purpose: Full Anthropic request body transform — handle cache strategies (including model-specific standby bridges), system sanitization, trailing whitespace tool prefill stripping, tool name prefixing, billing headers, and body signing
